...
if( ! function_exists( 'themeblvd_header_content_default' ) ) {
    ...
    if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('moki-search') ) : ?><?php endif; ?>
					<div class="clear"></div>
				</div><!-- .inner (end) -->
			</div><!-- .container (end) -->
...
if( ! function_exists( 'themeblvd_header_menu_default' ) ) {
	function themeblvd_header_menu_default() {
		if( themeblvd_get_option( 'responsive_css', null, 'true' ) != 'false' && themeblvd_get_option( 'mobile_nav', null, 'mobile_nav_graphic' ) != 'mobile_nav_graphic' )
